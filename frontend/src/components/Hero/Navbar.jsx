    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white bg-opacity-90 backdrop-blur-md shadow-sm">
      <div className="w-full max-w-7xl mx-auto flex h-16 items-center justify-between px-2 sm:px-4 lg:px-8">
        ...
        <nav className="flex flex-1 items-center justify-between">
          ...
          <button className="hidden md:flex items-center rounded-full bg-blue-600 px-6 py-3 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
            <User className="w-5 h-5 mr-2" />
            Login
          </button>
          <button className="md:hidden flex items-center p-2 text-gray-700 hover:text-blue-600 focus:outline-none" onClick={toggleMobileMenu}>
